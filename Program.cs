...
// app.UseCors(options =>
// {
//     options.WithOrigins("http://localhost:3000", "http://localhost:3001", "http://localhost:3002"); //อนุญาติที่เข้าถึง api
//     options.WithHeaders("Content-Type", "Authorization", "Accept"); // อนุญาติ header
